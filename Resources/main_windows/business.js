...
var imageCollection1 = ['http://amihud.com/ec/images/hookey.jpg', 'http://amihud.com/ec/images/logo.JPG', 'http://amihud.com/ec/images/1000312_10151743449039710_5992176_n.jpg', 'http://amihud.com/ec/images/hookey.jpg'];
	...
	request.onload = function() {
		...
		if (json) {
			try {
				...
				for (var i = 0; i < lenRes; i++) {
					nameArrayView.push(Ti.UI.createView({
						width : 216,
						height : 156,
						backgroundImage : '../images/business/hand.png'
					}));
				}
...
function displayType(firstType, nameArrayView, business, usr_id, usr_email) {
	...
	var natural = Ti.UI.createView({
		width : 216,
		height : 156,
		backgroundImage : '../images/business/natural.png'
	});
	var panbusiness = Ti.UI.createView({
		width : 216,
		height : 156,
		backgroundImage : '../images/business/pan.png'
	});
	var stuffedbusiness = Ti.UI.createView({
		width : 216,
		height : 156,
		backgroundImage : '../images/business/stuffedbusiness.png'
	});
	var thinNCrispy = Ti.UI.createView({
		width : 216,
		height : 156,
		backgroundImage : '../images/business/thinNcrispy.png'
	});
	...
	var business1 = [{
		title : 'Hand Made',
		path : '../images/business/hand.png',
		container : 1
	}, {
		title : 'Natural',
		path : '../images/business/natural.png',
		container : 2
	}, {
		title : 'Pan business',
		path : '../images/business/pan.png',
		container : 3
	}, {
		title : 'Stuffed business',
		path : '../images/business/stuffedbusiness.png',
		container : 4
	}, {
		title : 'Thin N Crispy business',
		path : '../images/business/thinNcrispy.png',
		container : 5
	}];
	...
	*/
	...
	next.addEventListener('click', function(e) {
		removeWinObj();
		next.enabled = false;
		if (business[scrollView.currentPage].title == 'event') {
			Ti.App.fireEvent('newcal', {
