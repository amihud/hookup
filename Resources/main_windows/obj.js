...
function displayObj(obj) {
	...
	var obj1 = [{
		title : 'Bacon Bits',
		path : '../images/obj/bacon_bits.png',
		container : null
	}, {
		title : 'Beef',
		path : '../images/obj/beef.png',
		container : null
	}, {
		title : 'Grilled Chicken',
		path : '../images/obj/grilled_chicken.png',
		container : null
	}, {
		title : 'Ham',
		path : '../images/obj/ham.png',
		container : null
	}, {
		title : 'Italian Sausage (Crumbled)',
		path : '../images/obj/italian_sausage_crumbled.png',
		container : null
	}, {
		title : 'Italian Sausage (Sliced)',
		path : '../images/obj/italian_sausage_sliced.png',
		container : null
	}, {
		title : 'Jalapenos',
		path : '../images/obj/jalapenos.png',
		container : null
	}, {
		title : 'Mushrooms',
		path : '../images/obj/mushrooms.png',
		container : null
	}, {
		title : 'Black Olives',
		path : '../images/obj/olives_black.png',
		container : null
	}, {
		title : 'Green Olives',
		path : '../images/obj/olives_green.png',
		container : null
	}, {
		title : 'Red Onions',
		path : '../images/obj/onions_red.png',
		container : null
	}, {
		title : 'White Onions',
		path : '../images/obj/onions_white.png',
		container : null
	}, {
		title : 'Pepperoni',
		path : '../images/obj/pepperoni.png',
		container : null
	}, {
		title : 'Banana Peppers',
		path : '../images/obj/peppers_banana.png',
		container : null
	}, {
		title : 'Green Peppers',
		path : '../images/obj/peppers_green.png',
		container : null
	}, {
		title : 'Red Peppers',
		path : '../images/obj/peppers_red.png',
		container : null
	}, {
		title : 'Pineapple',
		path : '../images/obj/pineapple.png',
		container : null
	}, {
		title : 'Pork',
		path : '../images/obj/pork.png',
		container : null
	}, {
		title : 'Diced Tomatoes',
		path : '../images/obj/tomatoes_diced.png',
		container : null
	}, {
		title : 'Marinated Tomatoes',
		path : '../images/obj/tomatoes_marinated.png',
		container : null
	}, {
		title : 'Roma Tomatoes',
		path : '../images/obj/tomatoes_roma.png',
		container : null
	}];
